    ...
    "paths": {
        ...
        "/api/v1/authors": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Author data (name is required with min 2 chars, role and bio are optional)",
                        "name": "author",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/authors/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated author data (all fields are optional for partial updates)",
                        "name": "author",
                        "in": "body",
                        "required": true,
                        "schema": {
